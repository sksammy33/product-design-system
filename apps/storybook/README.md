...
Navigation reserves Foundations, Components, Accessibility and QA; the Button, Input, Textarea and QA tooling stories are executable. Button stories run with axe checks in Light and Dark themes using the current Figma-derived tokens. There is no deployment or screenshot baseline. See [development tooling](../../docs/development.md).
