...
- `variables-01.json` through `variables-11.json`: 30 variables per bounded response (27 in the final batch), with source offsets and total count: 327 variables, one more than the previous uncommitted snapshot.
- `styles.json`: 16 complete text-style records and 15 effect-style records, separately from variables.
