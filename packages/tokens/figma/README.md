...
- `variables-01.json` through `variables-11.json`: 30 variables per bounded response (17 in the final batch), with source offsets and total count: 317 variables, one more than the previous snapshot.
